...
import StrategicPlanning from './components/level1/innovative/StrategicPlanning.vue'; // Import StrategicPlanning.vue
import ImplementationMonitoring from './components/level1/innovative/ImplementationMonitoring.vue';
import EvaluationControl from './components/level1/innovative/EvaluationControl.vue';
import StrategicGrowth from './components/level1/innovative/StrategicGrowth.vue';
import LongStrategy from './components/level1/innovative/LongStrategy.vue';
import CrisisManagement from './components/level1/innovative/CrisisManagement.vue';
...
const routes = [
  ...
  { path: '/budget-allocation', name: 'BudgetAllocation', component: BudgetAllocation },
  { path: '/goal-setting', name: 'GoalSetting', component: GoalSetting },
  ...
  { path: '/strategic-planning', name: 'StrategicPlanning', component: StrategicPlanning }, // Add route for StrategicPlanning
  { path: '/implementation-monitoring', name: 'ImplementationMonitoring', component: ImplementationMonitoring },
  { path: '/evaluation-control', name: 'EvaluationControl', component: EvaluationControl },
  { path: '/strategic-growth', name: 'StrategicGrowth', component: StrategicGrowth },
  { path: '/long-strategy', name: 'LongStrategy', component: LongStrategy },
  { path: '/crisis-management', name: 'CrisisManagement', component: CrisisManagement },
  { path: '/innovation-market', name: 'InnovationMarket', component: InnovationMarket },
  { path: '/reflection-evaluation', name: 'ReflectionEvaluation', component: ReflectionEvaluation },
  { path: '/legacy-building', name: 'LegecyBuilding', component: LegecyBuilding },
];
